    ...
    function w(e) {
      ...
      if (
        ...
        for (s = 0, b = f.length; s < b; ++s) {
          if (f[s].length > 0 && (g.endsWith(f[s]) || f[s] == p)) {
            t = 'download';
            break;
          }
        }
    ...
    function v(i) {
      ...
      if (l && l.href && !l.hasAttribute('xlink:href')) {
        var A = l.href,
          ...
          v = l.getAttribute('data-vars-ga-label');
        e.el = l;
        e.el_href = l.href;
        ...
        if (r !== 'internal' && r !== 'javascript') {
          ...
          if (K || r == 'mailto' || r == 'tel') {
            if (r == 'download') {
              s = { event_category: 'download', event_label: v || e.title };
            } else if (r == 'tel') {
              s = {
                event_category: 'tel',
                event_label: v || e.title.replace('tel:', ''),
              };
            } else if (r == 'mailto') {
              console.log(v || e.title.replace('mailto:', ''));
              s = {
                event_category: 'mailto',
                event_label: v || e.title.replace('mailto:', ''),
              };
            } else if (r == 'internal-as-outbound') {
              s = { event_category: a, event_label: v || e.title };
            } else if (r == 'external') {
              s = {
                event_category: 'outbound-link',
                event_label: v || e.title,
              };
            ...
            if (s) {
              ...
              if (r && r != 'internal') {
                s = { event_category: r, event_label: v || e.title };
                t('event', T || A, s, e);
              } else {
                e.exit = 'type';
                n(e);
