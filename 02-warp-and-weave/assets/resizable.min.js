  ...
  return (
    z.widget('ui.resizable', z.ui.mouse, {
      ...
      _hasScroll: function (t, i) {
        ...
        var e = i && 'left' === i ? 'scrollLeft' : 'scrollTop',
          i = !1;
        return 0 < t[e] || ((t[e] = 1), (i = 0 < t[e]), (t[e] = 0), i);
      },
      _create: function () {
        var t,
          i = this.options,
        ...
        this._addClass('ui-resizable'),
          ...
          this.element[0].nodeName.match(
            ...
            (this.element.wrap(
              z("<div class='ui-wrapper' style='overflow: hidden;'></div>").css(
                {
          ...
          i.autoHide &&
            z(this.element)
              .on('mouseenter', function () {
                i.disabled ||
                  (e._removeClass('ui-resizable-autohide'), e._handles.show());
              })
          ...
          for (i in ((t = t || this.element), this.handles))
            this.handles[i].constructor === String
              ...
              this.elementIsWrapper &&
                ...
                ((e = z(this.handles[i], this.element)),
      ...
      _mouseStart: function (t) {
        ...
        return (
          ...
          (s = z('.ui-resizable-' + this.axis).css('cursor')),
          z('body').css('cursor', 'auto' === s ? this.axis + '-resize' : s),
      ...
      _mouseStop: function (t) {
        ...
        return (
          this._helper &&
            ...
            h.animate || this.element.css(z.extend(i, { top: s, left: e })),
      ...
      _updateVirtualBoundaries: function (t) {
        ...
        (this._aspectRatio || t) &&
          ((i = h.minHeight * this.aspectRatio),
          (e = h.minWidth / this.aspectRatio),
          (s = h.maxHeight * this.aspectRatio),
          (t = h.maxWidth / this.aspectRatio),
          i > h.minWidth && (h.minWidth = i),
          e > h.minHeight && (h.minHeight = e),
          s < h.maxWidth && (h.maxWidth = s),
          t < h.maxHeight && (h.maxHeight = t)),
          (this._vBoundaries = h);
      },
      ...
      _updateRatio: function (t) {
        ...
        return (
          ...
          'sw' === s &&
            ((t.left = i.left + (e.width - t.width)), (t.top = null)),
          'nw' === s &&
      ...
      _renderProxy: function () {
        ...
        (this.elementOffset = t.offset()),
          this._helper
            ? ((this.helper =
                this.helper || z("<div style='overflow:hidden;'></div>")),
    ...
    z.ui.plugin.add('resizable', 'animate', {
      stop: function (i) {
        var e = z(this).resizable('instance'),
          ...
          h = { width: e.size.width - o, height: e.size.height - n },
          o =
        ...
        e.element.animate(z.extend(h, n && o ? { top: n, left: o } : {}), {
          ...
          step: function () {
            ...
            s && s.length && z(s[0]).css({ width: t.width, height: t.height }),
              e._updateCache(t),
    ...
    z.ui.plugin.add('resizable', 'containment', {
          ...
          /document/.test(n) || n === document
            ? ((h.containerOffset = { left: 0, top: 0 }),
              ...
              (h.parentData = {
                ...
                height:
                  z(document).height() || document.body.parentNode.scrollHeight,
              }))
            : ((e = z(o)),
              (s = []),
              ...
              (n = h._hasScroll(o, 'left') ? o.scrollWidth : n),
      ...
      resize: function (t) {
        ...
        a[0] !== document && /static/.test(a.css('position')) && (o = s),
          ...
          (h = Math.abs(
            i.sizeDiff.width +
              (i._helper ? i.offset.left - o.left : i.offset.left - s.left)
          )),
          (s = Math.abs(
            i.sizeDiff.height +
              (i._helper ? i.offset.top - o.top : i.offset.top - s.top)
          )),
      ...
      stop: function () {
        ...
        t._helper &&
          ...
          z(this).css({ left: o.left - s.left - e.left, width: a, height: n }),
          t._helper &&
            !i.animate &&
    ...
    z.ui.plugin.add('resizable', 'grid', {
      resize: function () {
        var t,
          ...
          m = e.maxHeight && e.maxHeight < u,
          c = e.minWidth && e.minWidth > g,
          s = e.minHeight && e.minHeight > u;
        (e.grid = a),
          c && (g += l),
          s && (u += r),
          f && (g -= l),
          ...
          /^(se|s|e)$/.test(o)
            ...
            : ((u - r <= 0 || g - l <= 0) &&
              ...
              0 < g - l
                ...
                : ((g = l - t.width),
                  (i.size.width = g),
                  (i.position.left = n.left + h.width - g)));
      },
    }),
    z.ui.resizable
  );
