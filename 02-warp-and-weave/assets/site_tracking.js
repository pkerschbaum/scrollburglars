if (
  typeof php_data.ac_settings.site_tracking != 'undefined' &&
  php_data.ac_settings.site_tracking == '1'
) {
  if (
    typeof php_data.ac_settings.tracking_actid === 'undefined' ||
    ...
    function acEnableTracking() {
      ...
      document.cookie =
        'ac_enable_tracking=1;samesite=none;secure; expires= ' +
        expiration +
        '; path=/';
    ...
    if (
      php_data.ac_settings.site_tracking_default == '1' ||
